...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-spring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-medium shadow-soft hover:-translate-y-0.5",
        ...
        hero: "bg-gradient-primary text-white hover:shadow-glow shadow-medium font-bold text-base hover:-translate-y-1",
        accent: "bg-gradient-accent text-white hover:shadow-glow shadow-medium font-bold hover:-translate-y-0.5",
      },
      size: {
